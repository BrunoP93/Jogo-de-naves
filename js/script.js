function start() { // Inicio da função start()
	...
	function explosao4(inimigo3X,inimigo3Y) {
		...
		var div4=$("#explosao4");
		div4.css("top", inimigo3Y);
		div4.css("left", inimigo3X);
		div4.animate({width:200, opacity:0}, "slow");
		
		var tempoExplosao4=window.setInterval(removeExplosao4, 1000);
		
		function removeExplosao4() {
